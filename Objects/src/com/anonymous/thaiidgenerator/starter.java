...
public class starter extends android.app.Service {
	...
	public void onCreate() {
        mostCurrent = this;
        if (processBA == null) {
		    processBA = new BA(this, null, null, "com.anonymous.thaiidgenerator", "com.anonymous.thaiidgenerator.starter");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			processBA.raiseEvent2(null, true, "CREATE", true, "com.anonymous.thaiidgenerator.starter", processBA, _service, anywheresoftware.b4a.keywords.Common.Density);
		}
